  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#f0ede6]">
      ...
      <section className="mx-auto max-w-4xl px-6 py-28 text-center">
        <div ref={badge} className="mb-4 inline-block rounded-full border border-[#c9b87a]/30 bg-[#c9b87a]/10 px-3 py-1 text-xs text-[#c9b87a]">
        ...
        <div ref={ctas} className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            href="/auth/login"
      ...
      <section id="how-it-works" className="border-t border-white/10 py-24">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            {[
              { step: "01", title: "Paste your resume bullets", desc: "Drop in the bullet points from your current resume — as many as you need.", ref: card1 },
              { step: "02", title: "Paste the job description", desc: "Copy the full job posting. The more detail, the better the match.", ref: card2 },
              { step: "03", title: "Get tailored bullets instantly", desc: "Receive rewritten bullets that mirror the job's keywords and tone.", ref: card3 },
      ...
      <section className="border-t border-white/10 py-24">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {/* Free */}
            <div ref={pricing1} className="rounded-2xl border border-white/10 bg-white/5 p-8 transition hover:border-white/20">
            ...
            {/* Pro */}
            <div ref={pricing2} className="rounded-2xl border border-[#c9b87a]/40 bg-[#c9b87a]/5 p-8 transition hover:border-[#c9b87a]/60">
